...
public class ResourceWebConfig implements WebMvcConfigurer {
    private static final String[] CLASSPATH_RESOURCE_LOCATIONS = {"classpath:/static/uploads/","classpath:/templates/", "./target/classes/static/uploads/images"}; // Khai báo đường dẫn tĩnh của các file resource
    @Override
